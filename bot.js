...
// ⚠️ Ajuste estes valores reais antes de publicar (o IBAN ainda é placeholder).
const PAYMENT_METHODS = {
  binance: { label: '🟡 Binance Pay', value: 'kumbovd@gmail.com' },
  express: { label: '💳 Unitel Money', value: '973476342' },
...
function buildPaymentText(order) {
  return (
    ...
    `Depois de pagar, envie o print/comprovativo aqui que um atendente confirma o seu pedido.`
  );
}
...
async function finalizeBooking(ctx, chatId) {
  ...
  try {
    ...
    let msg = `✅ Agendamento criado!\nData: ${st.dt.toLocaleString(DateTime.DATETIME_MED)}\nServiço: ${data.tipoServico}\n\n` +
      'Você pode acompanhar o site e tentar garantir a vaga sozinho (a) — ou deixar essa responsabilidade com a nossa equipe. Com o nosso serviço de 🔔 Notificações, 🤖 Reserva Automática ou 📄 Lista de Espera Automática, nós monitoramos o site por você e garantimos a vaga assim que ela aparecer, sem que precise ficar verificando o tempo todo, TEMOS BOT QUE VERIFICAM MAIS DE 10 CONTAS A CADA 12/12H NAS CONTAS VFS BLS,

Toque em 🗂️ Nossos Serviços para conhecer os planos e deixar essa parte com a gente,
Clica aqui para voltar ao menu /start.';
